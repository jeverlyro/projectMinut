...
const HISTORY_DATA = [
  {
    ...
    year: "1694-1945",
    description:
      "Minahasa Utara didirikan di bawah pemerintahan kolonial Belanda, menjadi pos perdagangan penting untuk rempah-rempah dan produk pertanian di Indonesia Timur.",
    image:
      "https://asset-a.grid.id/crop/0x0:0x0/700x465/photo/2023/01/14/kerja-rodijpg-20230114120151.jpg",
  },
  {
    id: "2",
    ...
    year: "1945-1995",
    description:
      "Setelah kemerdekaan Indonesia, wilayah ini mulai mengembangkan identitas budayanya yang unik sambil mempertahankan praktik tradisionalnya.",
    image:
      "https://asset.kompas.com/crops/M6g2jc3L0CM75Yx3Mp4sD6_cZfg=/25x0:577x368/780x390/data/photo/2024/04/28/662e681b5c936.jpg",
  },
  {
    id: "3",
    ...
    year: "1995-Sekarang",
    description:
      "Minahasa Utara secara resmi dibentuk sebagai kabupaten pada tahun 2003, memisahkan diri dari Kabupaten Minahasa untuk lebih baik melayani kebutuhan unik masyarakatnya.",
    image:
      "https://lh3.googleusercontent.com/-yCDeqL43WNk/ZHnxlZrdflI/AAAAAAAAAgg/XdR1bhkJaUEgNn_AuGS7SAYRUJnNP1T5wCNcBGAsYHQ/s1600/e60ce523bb2772ee4c60396e8b51974610690d8bc39ca0705da0288624d41aac.0.JPG.jpg",
  },
];
...
const CULTURAL_LANDMARKS = [
  {
    ...
    name: "Pulau Lihaga",
    description:
      "Pantai pasir putih yang masih alami dengan air kristal yang jernih",
  ...
  },
  {
    ...
    name: "Pulau Gangga",
    description:
      "Terkenal dengan terumbu karang yang indah dan tempat menyelam",
  ...
  },
  {
    ...
    name: "Gunung Klabat",
    description:
      "Puncak tertinggi di Sulawesi Utara dengan pemandangan yang menakjubkan",
...
const LOCAL_FOODS = [
  {
    ...
    description:
      "Bubur sayur dengan nasi kuning dan berbagai macam rempah lokal",
    image:
      "https://asset.kompas.com/crops/8IPl4RcIfLh3fkwXhKHPuPHqoz8=/81x22:892x563/750x500/data/photo/2020/05/13/5ebbdec618a37.jpg",
  },
  {
    id: "2",
    name: "Cakalang Fufu",
    ...
    image:
      "https://resepmamiku.com/wp-content/uploads/2022/06/cakalang-fufu-rica-rica-yscooking-e1681434213206-850x771.jpg",
  },
];
      ...
      <ScrollView>
        <View style={styles.contentSection}>
          ...
          <View style={styles.overviewCard}>
            <Text style={styles.overviewText}>
              ...
              Indonesia, yang didirikan pada tahun 2003. Terkenal dengan
              pantainya yang menakjubkan, air laut yang jernih, dan warisan
              budaya yang kaya, kabupaten ini merupakan permata tersembunyi di
              Indonesia Timur.
            </Text>
        ...
        <View style={styles.contentSection}>
          ...
          <View style={styles.artCard}>
            <Image
              source={{ uri: "https://source.unsplash.com/7b9a04MFields" }}
              style={styles.artImage}
            />
            <View style={styles.artContent}>
              <Text style={styles.artTitle}>Tari Cakalele</Text>
              <Text style={styles.artDescription}>
                Tarian perang tradisional masyarakat Minahasa yang ditampilkan
                selama upacara dan perayaan. Penari menggunakan perisai dan
                tombak sambil bergerak dalam pola yang sinkron.
              </Text>
