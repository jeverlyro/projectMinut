...
const ProfileScreen = ({ navigation }: any) => {
  const [user, setUser] = useState({
    ...
    background:
      "https://api2.kemenparekraf.go.id/storage/app/resources/image_artikel/shutterstock_1870209874_Sony%20Herdiana.jpg",
  });
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.menuContainer}>
          ...
          >
            <Ionicons name="key-outline" size={24} color="#212529" />
          ...
          >
            <Ionicons name="bookmark-outline" size={24} color="#212529" />
            <Text style={styles.menuText}>File yang Disimpan</Text>
          </TouchableOpacity>
        ...
        <View style={styles.logoutContainer}>
          <Text style={styles.logoutTitle}>My Account</Text>
          <TouchableOpacity
